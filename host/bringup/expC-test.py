...
LOG_DIR = "/home/gihwan/mps4/boot-capture-logs/expC-um0-ti2"
CAPTURE_SECONDS = 120
...
print("=== FI101 AN 109762 EXP C: UARTMODE 0 / TOTALIMAGES 2 (FPGA UART0 exposed, no DDR.BIN) ===", flush=True)
print("VERBOSE MODE - files temporarily modified, restore after", flush=True)
