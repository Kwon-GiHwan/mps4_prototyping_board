...
Found by feeding a U55 artifact to a U85 configure. This is a second line of
defence against the "one binary, wrong model" failure the 133-cell build count
was derived to prevent — the build refuses rather than producing plausible
